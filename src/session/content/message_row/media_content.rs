...
mod imp {
    ...
    #[template(resource = "/com/github/melix99/telegrand/ui/content-message-media-content.ui")]
    pub struct MessageMediaContent {
        #[template_child]
    ...
    impl ObjectSubclass for MessageMediaContent {
        const NAME: &'static str = "ContentMessageMediaContent";
        type Type = super::MessageMediaContent;
    ...
    impl ObjectImpl for MessageMediaContent {
    ...
    impl WidgetImpl for MessageMediaContent {
        fn measure(
            &self,
            _widget: &Self::Type,
...
glib::wrapper! {
    pub struct MessageMediaContent(ObjectSubclass<imp::MessageMediaContent>)
        @extends gtk::Widget;
}

impl Default for MessageMediaContent {
    fn default() -> Self {
        Self::new()
    }
}

impl MessageMediaContent {
    pub fn new() -> Self {
        glib::Object::new(&[]).expect("Failed to create MessageMediaContent")
    }
